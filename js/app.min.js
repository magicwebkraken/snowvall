(() => {
    ...
    let s = !0,
        ...
        r = (e = 500) => {
            if (s) {
                ...
                })), document.body.style.paddingRight = i, document.documentElement.classList.add("lock"), s = !1, setTimeout((function () {
                    s = !0
                }), e)
            }
        };
    ...
    let l = (e, t = !1, s = 500, i = 0) => {
        ...
        if (r) {
            ...
            if (t) {
                ...
                e.classList.contains("_header-scroll") ? l = e.offsetHeight : (e.style.cssText = "transition-duration: 0s;", e.classList.add("_header-scroll"), l = e.offsetHeight, e.classList.remove("_header-scroll"), setTimeout((() => {
                    e.style.cssText = ""
                }), 0))
            }
            let d = {
            ...
            if (document.documentElement.classList.contains("menu-open") && n(), "undefined" != typeof SmoothScroll)(new SmoothScroll).animateScroll(r, "", d);
            else {
                let e = r.getBoundingClientRect().top + scrollY;
                e = l ? e - l : e, e = i ? e - i : e, window.scrollTo({
                    top: e,
                    behavior: "smooth"
                })
            }
        ...
        for (let i = 1; i < arguments.length; i += 1) {
            ...
            if (null != r && (s = r, !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
                ...
                for (let t = 0, i = s.length; t < i; t += 1) {
                    ...
                    void 0 !== n && n.enumerable && (w(e[i]) && w(r[i]) ? r[i].__swiper__ ? e[i] = r[i] : S(e[i], r[i]) : !w(e[i]) && w(r[i]) ? (e[i] = {}, r[i].__swiper__ ? e[i] = r[i] : S(e[i], r[i])) : e[i] = r[i])
                }
            }
        }
        var s;
        ...
        const d = s > n ? "next" : "prev",
            ...
            p = () => {
                ...
                if (c(u, s) && (u = s), t.wrapperEl.scrollTo({
                        [i]: u
                    }), c(u, s)) return t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.scrollSnapType = "", setTimeout((() => {
    ...
    function _(e) {
        return void 0 === e && (e = {}), O || (O = function (e) {
            ...
            const p = n.match(/(iPod)(.*OS\s([\d_]+))?/),
                ...
                h = "Win32" === r;
            let f = "MacIntel" === r;
            return !c && f && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${l}`) >= 0 && (c = n.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), f = !1), d && !h && (a.os = "android", a.android = !0), (c || u || p) && (a.os = "ios", a.ios = !0), a
        }(e)), O
    }
        ...
        F = e => {
            ...
            if (e.params.rewind || e.params.loop)
                for (let i = r - t; i <= n + t; i += 1) {
                    ...
                    for (let i = Math.max(r - t, 0); i <= Math.min(n + t, s - 1); i += 1) i !== r && (i > n || i < r) && N(e, i)
        };
    var W = {
        updateSize: function () {
            const e = this;
            let t, s;
            const i = e.el;
            t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth, s = void 0 !== e.params.height && null !== e.params.height ? e.params.height : i.clientHeight, 0 === t && e.isHorizontal() || 0 === s && e.isVertical() || (t = t - parseInt(C(i, "padding-left") || 0, 10) - parseInt(C(i, "padding-right") || 0, 10), s = s - parseInt(C(i, "padding-top") || 0, 10) - parseInt(C(i, "padding-bottom") || 0, 10), Number.isNaN(t) && (t = 0), Number.isNaN(s) && (s = 0), Object.assign(e, {
                width: t,
                height: s,
        ...
        updateSlides: function () {
            ...
            for (let i = 0; i < p; i += 1) {
                let r;
                if (P = 0, c[i] && (r = c[i]), M && e.grid.updateSlide(i, r, c), !c[i] || "none" !== C(r, "display")) {
                    if ("auto" === s.slidesPerView) {
                        k && (c[i].style[e.getDirectionLabel("width")] = "");
                        const n = getComputedStyle(r),
                            a = r.style.transform,
                            o = r.style.webkitTransform;
                        if (a && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), s.roundLengths) P = e.isHorizontal() ? L(r, "width", !0) : L(r, "height", !0);
                        else {
                            const e = t(n, "width"),
                                s = t(n, "padding-left"),
                                i = t(n, "padding-right"),
                        ...
                        a && (r.style.transform = a), o && (r.style.webkitTransform = o), s.roundLengths && (P = Math.floor(P))
                    } else P = (n - (s.slidesPerView - 1) * S) / s.slidesPerView, s.roundLengths && (P = Math.floor(P)), c[i] && (c[i].style[e.getDirectionLabel("width")] = `${P}px`);
                    c[i] && (c[i].swiperSlideSize = P), m.push(P), s.centeredSlides ? (T = T + P / 2 + y / 2 + S, 0 === y && 0 !== i && (T = T - n / 2 - S), 0 === i && (T = T - n / 2 - S), Math.abs(T) < .001 && (T = 0), s.roundLengths && (T = Math.floor(T)), x % s.slidesPerGroup == 0 && u.push(T), h.push(T)) : (s.roundLengths && (T = Math.floor(T)), (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && u.push(T), h.push(T), T = T + P + S), e.virtualSize += P + S, y = P, x += 1
                }
            }
            if (e.virtualSize = Math.max(e.virtualSize, n) + g, a && o && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize+S}px`), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize+S}px`), M && e.grid.updateWrapperSize(P, u), !s.centeredSlides) {
                const t = [];
            ...
            if (Object.assign(e, {
                ...
                b(i, "--swiper-centered-offset-before", -u[0] + "px"), b(i, "--swiper-centered-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
                const t = -e.snapGrid[0],
                    s = -e.slidesGrid[0];
                e.snapGrid = e.snapGrid.map((e => e + t)), e.slidesGrid = e.slidesGrid.map((e => e + s))
            }
            if (p !== d && e.emit("slidesLengthChange"), u.length !== v && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== w && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(l || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
        ...
        updateSlidesProgress: function (e) {
            ...
            for (let e = 0; e < i.length; e += 1) {
                ...
                f && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), $(l, f, s.slideVisibleClass), $(l, m, s.slideFullyVisibleClass), l.progress = r ? -c : c, l.originalProgress = r ? -p : p
            }
        },
    ...
    var H = {
        slideTo: function (e, t, s, i, r) {
            ...
            let w;
            a !== (c || 0) && s && n.emit("beforeSlideChangeStart"), n.updateProgress(v), w = a > p ? "next" : a < p ? "prev" : "reset";
            const S = n.virtual && n.params.virtual.enabled;
            if (!(S && r) && (u && -v === n.translate || !u && v === n.translate)) return n.updateActiveIndex(a), o.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), "slide" !== o.effect && n.setTranslate(v), "reset" !== w && (n.transitionStart(s, w), n.transitionEnd(s, w)), !1;
            if (o.cssMode) {
                const e = n.isHorizontal(),
                    s = u ? v : -v;
        ...
        slideToClickedSlide: function () {
            ...
            if (t.loop) {
                ...
                r = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? n < e.loopedSlides - i / 2 || n > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), n = e.getSlideIndex(E(s, `${a}[data-swiper-slide-index="${r}"]`)[0]), f((() => {
                    e.slideTo(n)
                }))) : e.slideTo(n) : n > e.slides.length - i ? (e.loopFix(), n = e.getSlideIndex(E(s, `${a}[data-swiper-slide-index="${r}"]`)[0]), f((() => {
                    e.slideTo(n)
                }))) : e.slideTo(n)
            } else e.slideTo(n)
        }
    ...
    var j = {
        ...
        loopFix: function (e) {
            ...
            d.length < f + v ? x("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : w && "row" === h.grid.fill && x("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
            const S = [],
                b = [];
            let T = l.activeIndex;
            void 0 === n ? n = l.getSlideIndex(d.find((e => e.classList.contains(h.slideActiveClass)))) : T = n;
            const y = "next" === i || !i,
                E = "prev" === i || !i;
            let M = 0,
                C = 0;
            const P = w ? Math.ceil(d.length / h.grid.rows) : d.length,
                L = (w ? d[n].column : n) + (m && void 0 === r ? -f / 2 + .5 : 0);
            if (L < v) {
                M = Math.max(v - L, g);
            ...
            if (l.__preventObserver__ = !0, requestAnimationFrame((() => {
                ...
                })), l.recalcSlides(), "auto" === h.slidesPerView ? l.updateSlides() : w && (S.length > 0 && E || b.length > 0 && y) && l.slides.forEach(((e, t) => {
                    l.grid.updateSlide(t, e, l.slides)
                })), h.watchSlidesProgress && l.updateSlidesOffset(), s)
                if (S.length > 0 && E) {
                    if (void 0 === t) {
                        const e = l.slidesGrid[T],
                            t = l.slidesGrid[T + M] - e;
                        o ? l.setTranslate(l.translate - t) : (l.slideTo(T + Math.ceil(M), 0, !1, !0), r && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - t, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - t))
                    } else if (r) {
                ...
                if (void 0 === t) {
                    ...
                    o ? l.setTranslate(l.translate - t) : (l.slideTo(T - C, 0, !1, !0), r && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - t, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - t))
                } else {
    ...
    function X(e) {
        ...
        if ("wrapper" === n.touchEventsTarget && ! function (e, t) {
                const s = m();
                let i = t.contains(e);
                !i && s.HTMLSlotElement && t instanceof HTMLSlotElement && (i = [...t.assignedElements()].includes(e), i || (i = function (e, t) {
                    const s = [t];
                    for (; s.length > 0;) {
                        const t = s.shift();
                        if (e === t) return !0;
        ...
        let w = !0;
        l.matches(r.focusableElements) && (w = !1, "SELECT" === l.nodeName && (r.isTouched = !1)), s.activeElement && s.activeElement.matches(r.focusableElements) && s.activeElement !== l && ("mouse" === i.pointerType || "mouse" !== i.pointerType && !l.matches(r.focusableElements)) && s.activeElement.blur();
        const S = w && t.allowTouchMove && n.touchStartPreventDefault;
        !n.touchStartForcePreventDefault && !S || l.isContentEditable || i.preventDefault(), n.freeMode && n.freeMode.enabled && t.freeMode && t.animating && !n.cssMode && t.freeMode.onTouchStart(), t.emit("touchStart", i)
    }
    ...
    function U(e) {
        ...
        if ((new Date).getTime(), i.isMoved && i.allowThresholdMove && w !== s.touchesDirection && S && b && Math.abs(f) >= 1) return Object.assign(n, {
            startX: c,
            startY: p,
            currentX: c,
            currentY: p,
        ...
        let T = !0,
            y = r.resistanceRatio;
        if (r.touchReleaseOnEdges && (y = 0), f > 0 ? (S && b && i.allowThresholdMove && i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] - ("auto" !== r.slidesPerView && s.slides.length - r.slidesPerView >= 2 ? s.slidesSizesGrid[s.activeIndex + 1] + s.params.spaceBetween : 0) - s.params.spaceBetween : s.minTranslate()) && s.loopFix({
                direction: "prev",
                setTranslate: !0,
                activeSlideIndex: 0
            }), i.currentTranslate > s.minTranslate() && (T = !1, r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + f) ** y))) : f < 0 && (S && b && i.allowThresholdMove && i.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] + s.params.spaceBetween + ("auto" !== r.slidesPerView && s.slides.length - r.slidesPerView >= 2 ? s.slidesSizesGrid[s.slidesSizesGrid.length - 1] + s.params.spaceBetween : 0) : s.maxTranslate()) && s.loopFix({
                direction: "next",
                setTranslate: !0,
    ...
    function K(e) {
        ...
        for (let e = 0; e < l.length; e += e < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
            ...
            void 0 !== l[e + t] ? (h || u >= l[e] && u < l[e + t]) && (m = e, v = l[e + t] - l[e]) : (h || u >= l[e]) && (m = e, v = l[l.length - 1] - l[l.length - 2])
        }
        let w = null,
            S = null;
        n.rewind && (t.isBeginning ? S = n.virtual && n.virtual.enabled && t.virtual ? t.virtual.slides.length - 1 : t.slides.length - 1 : t.isEnd && (w = 0));
        const b = (u - l[m]) / v,
            T = m < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup;
        if (p > n.longSwipesMs) {
            if (!n.longSwipes) return void t.slideTo(t.activeIndex);
            "next" === t.swipeDirection && (b >= n.longSwipesRatio ? t.slideTo(n.rewind && t.isEnd ? w : m + T) : t.slideTo(m)), "prev" === t.swipeDirection && (b > 1 - n.longSwipesRatio ? t.slideTo(m + T) : null !== S && b < 0 && Math.abs(b) > n.longSwipesRatio ? t.slideTo(S) : t.slideTo(m))
        } else {
            if (!n.shortSwipes) return void t.slideTo(t.activeIndex);
            t.navigation && (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl) ? r.target === t.navigation.nextEl ? t.slideTo(m + T) : t.slideTo(m) : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : m + T), "prev" === t.swipeDirection && t.slideTo(null !== S ? S : m))
        }
    }
    ...
    const se = (e, t) => {
        ...
        r && "string" != typeof r && (s[l]("touchstart", e.onDocumentTouchStart, {
            ...
            passive: !0
        }), (i.preventClicks || i.preventClicksPropagation) && r[l]("click", e.onClick, !0), i.cssMode && n[l]("scroll", e.onScroll), i.updateOnWindowResize ? e[d](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", Q, !0) : e[d]("observerUpdate", Q, !0), r[l]("load", e.onLoad, {
            capture: !0
        }))
    };
    ...
    const ae = {
            ...
            transition: {
                ...
                transitionStart: function (e, t) {
                    ...
                    i.cssMode || (i.autoHeight && s.updateAutoHeight(), q({
                        swiper: s,
                        runCallbacks: e,
                        direction: t,
                        step: "Start"
                ...
                transitionEnd: function (e, t) {
                    ...
                    s.animating = !1, i.cssMode || (s.setTransition(0), q({
                        swiper: s,
                        runCallbacks: e,
                        direction: t,
                        step: "End"
            ...
            events: {
                attachEvents: function () {
                    ...
                    e.onTouchStart = X.bind(e), e.onTouchMove = U.bind(e), e.onTouchEnd = K.bind(e), e.onDocumentTouchStart = te.bind(e), t.cssMode && (e.onScroll = J.bind(e)), e.onClick = Z.bind(e), e.onLoad = ee.bind(e), se(e, "on")
                },
            ...
            breakpoints: {
                setBreakpoint: function () {
                    ...
                    const a = u(),
                        ...
                        l = ["window", "container"].includes(i.breakpointsBase) || !i.breakpointsBase ? e.el : a.querySelector(i.breakpointsBase),
                    ...
                    const c = (d in n ? n[d] : void 0) || e.originalParams,
                        ...
                        f = c.grabCursor,
                        g = i.enabled;
                    p && !h ? (r.classList.remove(`${i.containerModifierClass}grid`, `${i.containerModifierClass}grid-column`), e.emitContainerClasses()) : !p && h && (r.classList.add(`${i.containerModifierClass}grid`), (c.grid.fill && "column" === c.grid.fill || !c.grid.fill && "column" === i.grid.fill) && r.classList.add(`${i.containerModifierClass}grid-column`), e.emitContainerClasses()), m && !f ? e.unsetGrabCursor() : !m && f && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach((t => {
                    ...
                    const v = c.direction && c.direction !== i.direction,
                        ...
                        b = i.loop;
                    v && s && e.changeDirection(), S(e.params, c);
                    ...
                    }), g && !T ? e.disable() : !g && T && e.enable(), e.currentBreakpoint = d, e.emit("_beforeBreakpoint", c), s && (w ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !b && y ? (e.loopCreate(t), e.updateSlides()) : b && !y && e.loopDestroy()), e.emit("breakpoint", c)
                },
    ...
    class le {
        constructor() {
            ...
            1 === i.length && i[0].constructor && "Object" === Object.prototype.toString.call(i[0]).slice(8, -1) ? t = i[0] : [e, t] = i, t || (t = {}), t = S({}, t), e && !t.el && (t.el = e);
            const n = u();
            ...
            const a = this;
            a.__swiper__ = !0, a.support = z(), a.device = _({
                userAgent: t.userAgent
            }), a.browser = G(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules);
            const o = {};
            a.modules.forEach((e => {
                e({
                    params: t,
            ...
            const l = S({}, re, o);
            return a.params = S({}, l, oe, t), a.originalParams = S({}, a.params), a.passedParams = S({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach((e => {
        ...
        getSlideIndex(e) {
            const {
                slidesEl: t,
                params: s
            } = this, i = P(E(t, `.${s.slideClass}, swiper-slide`)[0]);
            return P(e) - i
        }
        ...
        mount(e) {
            ...
            return !r && t.params.createElements && (r = M("div", t.params.wrapperClass), s.append(r), E(s, `.${t.params.slideClass}`).forEach((e => {
                r.append(e)
            }))), Object.assign(t, {
                el: s,
                wrapperEl: r,
    ...
    function de(e) {
        ...
        s({
            ...
            e = k(e), s = k(s), t.enabled ? o() : [...e, ...s].filter((e => !!e)).forEach((e => e.classList.add(t.params.navigation.lockClass)))
        })), i("click", ((e, s) => {
            let {
                nextEl: i,
                prevEl: n
            ...
            if (t.params.navigation.hideOnClick && !o) {
                ...
                let e;
                i.length ? e = i[0].classList.contains(t.params.navigation.hiddenClass) : n.length && (e = n[0].classList.contains(t.params.navigation.hiddenClass)), r(!0 === e ? "navigationShow" : "navigationHide"), [...i, ...n].filter((e => !!e)).forEach((e => e.classList.toggle(t.params.navigation.hiddenClass)))
            }
        }));
        const u = () => {
    ...
    Object.keys(ae).forEach((e => {
        ...
        document.querySelector(".swiper") && new le(".swiper", {
            modules: [de, ue],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
    ...
    e.watcher = new class {
        ...
        scrollWatcherConstructor(e) {
            if (e.length) {
                this.scrollWatcherLogging(`Прокинувся, стежу за об'єктами (${e.length})...`), o(Array.from(e).map((function (e) {
                    if ("navigator" === e.dataset.watch && !e.dataset.watchThreshold) {
                        let t;
                        e.clientHeight > 2 ? (t = window.innerHeight / 2 / (e.clientHeight - 1), t > 1 && (t = 1)) : t = 1, e.setAttribute("data-watch-threshold", t.toFixed(2))
                    }
                    ...
                    let s = t.split("|"),
                        ...
                        r = Array.from(e).filter((function (e) {
                            ...
                            if (String(t) === i.root && String(s) === i.margin && String(r) === i.threshold) return e
                        })),
        ...
        getScrollWatcherConfig(e) {
            let t = {};
            if (document.querySelector(e.root) ? t.root = document.querySelector(e.root) : "null" !== e.root && this.scrollWatcherLogging(`Эмм... батьківського об'єкта ${e.root} немає на сторінці`), t.rootMargin = e.margin, !(e.margin.indexOf("px") < 0 && e.margin.indexOf("%") < 0)) {
                if ("prx" === e.threshold) {
                    e.threshold = [];
        ...
        scrollWatcherCreate(e) {
            console.log(e), this.observer = new IntersectionObserver(((e, t) => {
                e.forEach((e => {
        ...
        scrollWatcherIntersecting(e, t) {
            e.isIntersecting ? (!t.classList.contains("_watcher-view") && t.classList.add("_watcher-view"), this.scrollWatcherLogging(`Я бачу ${t.classList}, додав клас _watcher-view`)) : (t.classList.contains("_watcher-view") && t.classList.remove("_watcher-view"), this.scrollWatcherLogging(`Я не бачу ${t.classList}, прибрав клас _watcher-view`))
        }
        scrollWatcherOff(e, t) {
            t.unobserve(e), this.scrollWatcherLogging(`Я перестав стежити за ${e.classList}`)
        }
        ...
        init() {
            this.оbjects = [], this.daClassname = "_dynamic_adapt_", this.nodes = [...document.querySelectorAll("[data-da]")], this.nodes.forEach((e => {
                const t = e.dataset.da.trim().split(","),
                    s = {};
                s.element = e, s.parent = e.parentNode, s.destination = document.querySelector(`${t[0].trim()}`), s.breakpoint = t[1] ? t[1].trim() : "767.98", s.place = t[2] ? t[2].trim() : "last", s.index = this.indexInParent(s.parent, s.element), this.оbjects.push(s)
            })), this.arraySort(this.оbjects), this.mediaQueries = this.оbjects.map((({
                breakpoint: e
            }) => `(${this.type}-width: ${e/16}em),${e}`)).filter(((e, t, s) => s.indexOf(e) === t)), this.mediaQueries.forEach((e => {
                const t = e.split(","),
                    s = window.matchMedia(t[0]),
                    i = t[1],
                    r = this.оbjects.filter((({
                        breakpoint: e
                    }) => e === i));
    ...
    const me = document.querySelector(".snow-box");
    let fe;

    function ge(e, t) {
        return Math.floor(Math.random() * (t - e + 1) + e)
    }
    fe = window.innerWidth > 767.98 ? 300 : 500, setInterval((() => {
            ! function () {
                const e = document.createElement("img");
                e.src = "img/SnowFlakes.png", e.style.top = `${ge(0,100)}%`, e.style.left = `${ge(0,100)}%`, e.style.width = `${ge(60,160)}px`, e.style.rotate = `${ge(0,360)}deg`, me.appendChild(e), setTimeout((() => {
                    e.remove()
                }), 4200)
            }()
        }), fe), document.addEventListener("click", (async function (e) {
            if (e.target.closest(".copy-ca-btn")) try {
                const e = document.getElementById("tokenValue").textContent.trim();
                await navigator.clipboard.writeText(e), alert("Address copied successfully")
            } catch (e) {
                console.error("Error copying address:", e), alert("Failed to copy address. Please try again.")
            }
        ...
        function () {
                ...
                if ("click" === t.type) {
                    ...
                    if (s.closest("[data-goto]")) {
                        const i = s.closest("[data-goto]"),
                            ...
                            d = i.dataset.gotoTop ? parseInt(i.dataset.gotoTop) : 0;
                        if (e.fullpage) {
                            const t = document.querySelector(`${r}`).closest("[data-fp-section]"),
                                s = t ? +t.dataset.fpId : null;
                            null !== s && (e.fullpage.switchingSection(s), document.documentElement.classList.contains("menu-open") && n())
                        } else l(r, a, o, d);
                        t.preventDefault()
                    }
                    ...
                    if ("navigator" === s.dataset.watch) {
                        ...
                        let t;
                        if (s.id && document.querySelector(`[data-goto="#${s.id}"]`)) t = document.querySelector(`[data-goto="#${s.id}"]`);
            ...
            if (document.addEventListener("click", s), document.addEventListener("watcherCallback", s), t()) {
                let e;
